...
const CACHE_NAME = "mandala-v87"; // v87 关系图谱+FAB上移+AI助手入口+主线支线简化 // v86 导图导出HTML+关联线点击删除 // v85 放射布局+优先级+版本历史 // v84 节点完成+跨分支关联线+导图模板 // v83 导图库管理+节点聚焦+转任务+save upsert // v82 备份补全+版本自动迁移+快照导出 // v81 独立导图入口+对话意图分类 // v80 81宫格与对照分开展示+导图面板抽屉
